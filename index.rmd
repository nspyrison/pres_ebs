...
glob_view <- global_view(this_ls, prim_obs, comp_obs, 
                         width_px = 1440 *(10/13), height_px = 480 * (10/13))
...
if(F){
  ...
  anim <- animate_gganimate(ggt, width = 720, height = 480, 
                            res = 72, unit = "px")
...
if(F){
  ...
  options(gganimate.dev_args = list(width = 720, height = 420))
  anim <- animate_gganimate(ggt, width = 720, height = 420, units = "px")
