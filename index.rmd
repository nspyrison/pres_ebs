...
- Intrinsic Data Dimensionality (idd) is an estimation of the dimensionality of the data; _eg._ a piece of paper exists in 3D, most of the time thickness is discarded.
...
3) If $p$ is sizable, say more than 10, embed the variables in fewer components, typically by eyeballing an elbow in a scree plot
    - "We capture 90% of the variation of our 20 variable in the first 5 principal components"
