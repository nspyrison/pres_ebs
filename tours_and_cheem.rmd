---
title: "Animated linear projections and novel appilcation to local explanations"
subtitle: "MadPy"
author: "Nicholas Spyrison"
length: "~45 minutes"
affiliation: "Monash University, IFF Madison"
...
- Dimension reduction
- Traditional linear dimension reduction
- Tours
- Local explanations
- Cheem
...
- *Affine* transformations: "parallel lines stay parallel"
- Examples:
...
- Inconsistent space; hard to communicate & interpret
...
- Often times our output space is of the same dimensionality as our input space
    ...
    - Or worse -- only showing PC1:2, with no recognition or discussion of the droped dimensions
...
- Number of embedded dimensions can be selected by eyeballing an elbow in a PCA screeplot
...
--
<br><br>
Visualize _one projection (or more if lucky);_ **static, not interactive**

---

# Tours

- Instead of viewing only static projections, *animate* small changes in the basis over time
...
--
<br>
__Novel__, package on CRAN, paper accepted to to Computational Statistics close to the new year

- model- and local explanation-agnostic (BYO)
- Illustrated with random forests and a tree SHAP (reduced computational complexity)
...
__Paper__, preprint, accepted to Computational Statistics: https://arxiv.org/abs/2205.05359
...
<!-- Removed 3 MTV motivation slides here -->
